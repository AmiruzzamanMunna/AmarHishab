		...
		<div class="card">
			...
			<div class="card-body">
                ...
                <div class="form-group">
                    <input type="submit" value="Login" onclick="checkLogin()" class="btn float-right login_btn">
                </div>
    ...
    function checkLogin(){
        ...
        $.ajax({
            ...
            success:function(data){
                ...
                html+='<strong>Sorry !</strong> Username & Password is incorrect.';
